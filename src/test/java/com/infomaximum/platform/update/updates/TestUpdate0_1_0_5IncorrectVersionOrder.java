...
public class TestUpdate0_1_0_5IncorrectVersionOrder extends UpdateTask<TestSubsystem> {

    public TestUpdate0_1_0_5IncorrectVersionOrder(TestSubsystem subsystem) {
        super(subsystem);
    }
