...
public class QueryPool {
    ...
    public static class QueryWrapper<T> {
        ...
        QueryWrapper(QueryPool queryPool, Component component, ContextTransaction context, Query<T> query) throws SubsystemException {
     ...
     */
    public <T> QueryFuture<T> tryExecuteImmediately(Component component, Query<T> query) throws SubsystemException {
     ...
     * @return null if query is not submitted
     */
    public <T> QueryFuture<T> tryExecuteImmediately(Component component, ContextTransaction context, Query<T> query) throws SubsystemException {
        if (hardException != null) {
            return null;
        }
